...
# license found at https://t.me/kurdistan_devblob/master/LICENSE
# Encoding = 'utf-8'
...
def start(client, message):
    kb = [[InlineKeyboardButton('Channel 🛡', url=chnnl),InlineKeyboardButton('Channel💥', url="https://t.me/kurdistan_dev")]]
    ...
    app.send_message(chat_id=message.from_user.id, text=f"Hello there, I am **TikTok Downloader Bot**.\nI can download TikTok video without Watermark.\n\n"
                          "__**Developer :**__ __@Mrnobody_090__\n"
